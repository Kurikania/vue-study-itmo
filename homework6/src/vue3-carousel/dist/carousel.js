...
const Navigation = (props, { slots }) => {
    ...
    const nextButton = vue.h('button', { class: 'carousel__next', onClick: setInterval(nav.next, 2000) }, (slotNext === null || slotNext === void 0 ? void 0 : slotNext()) || vue.h(Icon, { name: 'arrowRight' }));
